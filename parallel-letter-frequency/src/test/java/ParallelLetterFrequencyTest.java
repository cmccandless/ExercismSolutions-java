...
public class ParallelLetterFrequencyTest {
    ...
    public void manyRepetitionsOfTheSameTextGiveAPredictableResult() {
        ...
        Map<Integer, Integer> expectedOutput = new HashMap<>();
        expectedOutput.put((int) 'a', 10000);
        expectedOutput.put((int) 'b', 10000);
        expectedOutput.put((int) 'c', 10000);
        ParallelLetterFrequency p = new ParallelLetterFrequency(b.toString());
    ...
    public void multipleThreadsGetUsed()
        ...
        Map<Integer, Integer> expectedOutput = new HashMap<Integer, Integer>();
        expectedOutput.put((int) 'a', 10000000);
        expectedOutput.put((int) 'b', 10000000);
        expectedOutput.put((int) 'c', 10000000);
        expectedOutput.put((int) 'd', 10000000);
        expectedOutput.put((int) 'e', 10000000);
        expectedOutput.put((int) 'f', 10000000);
        expectedOutput.put((int) 'g', 10000000);
        expectedOutput.put((int) 'h', 10000000);
        expectedOutput.put((int) 'i', 10000000);
        expectedOutput.put((int) 'j', 10000000);
        expectedOutput.put((int) 'k', 10000000);
        expectedOutput.put((int) 'l', 10000000);
        expectedOutput.put((int) 'm', 10000000);
        expectedOutput.put((int) 'n', 10000000);
        expectedOutput.put((int) 'o', 10000000);
        expectedOutput.put((int) 'p', 10000000);
        expectedOutput.put((int) 'q', 10000000);
        expectedOutput.put((int) 'r', 10000000);
        expectedOutput.put((int) 's', 10000000);
        expectedOutput.put((int) 't', 10000000);
        expectedOutput.put((int) 'u', 10000000);
        expectedOutput.put((int) 'v', 10000000);
        expectedOutput.put((int) 'w', 10000000);
        expectedOutput.put((int) 'x', 10000000);
        expectedOutput.put((int) 'y', 10000000);
        expectedOutput.put((int) 'z', 10000000);
        ...
        // assertEquals(expectedOutput, multiCounts);
    }
}
